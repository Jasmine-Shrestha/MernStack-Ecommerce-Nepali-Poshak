...
{/** this toast is imported from react toast that are in app.jsx for notification to select size if not selected. */}
    const addToCart = async (itemId,size) => {
        ...
        // this iis logic for cart to select the items
...
{/** here we will add function for cart to add all the amount of the selected item */}
const getCartAmount = () => {
    let totalAmount = 0;
    for (const items in cartItems){
